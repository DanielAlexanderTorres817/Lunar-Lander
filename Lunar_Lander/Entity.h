...
private:
    ...
    // ————— TRANSFORMATIONS ————— //
    glm::vec3 m_movement = glm::vec3(0.0f, 2.5f, 0.0f);
    glm::vec3 m_position;
    glm::vec3 m_scale;
    glm::vec3 m_velocity;
...
public:
    ...
    void move_left() { m_movement.x = -0.1f; face_left(); };
    void move_right() { m_movement.x = 0.1f;  face_right(); };
    ...
    //char const get_win_status()      const { return win_status; }
    ...
    //char const set_win_status(char new_status) { win_status =  new_status; }
